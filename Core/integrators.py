...
def euler_step(bodies: list[Body], accelerations: list[tuple[float, float]], dt: float) -> None:
...
def rk4_step(bodies: list[Body], get_acc_func, dt: float) -> None:
    ...
    # k2: ускорения в середине шага (по скоростям k1)
    ...
    # k3: ускорения в середине шага (по скоростям k2)
